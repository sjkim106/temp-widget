...
import CounterChartComponent from '../chart/counterChartComponent';
        ...
        <section className="dash_info_wrap">                           
            ...
            <div className="dash_body">                
                ...
                <div className="chart_in">                    
                    <div className="counter_chart" id="counterColumncht01">
                ...
                <div className="list_box">
                    ...
                    <div className="chart_in">                    
                        <div className="counter_chart" id="counterColumncht02">
                            <CounterChartComponent />
                        </div>
                    </div>
                    <div className="list_row sensor_count">
